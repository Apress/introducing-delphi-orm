...
type
  ...
  [Model('Database')]
  [Id('FWeek', TIdGenerator.IdentityOrSequence)]
  TAbandonRatePerDepartment = class
  private
...
//    FID: TGuid;
    ...
    [ManyValuedAssociation([TAssociationProp.Lazy], [TCascadeType.SaveUpdate, TCascadeType.Merge], 'FAgentID')]
...
//    property ID: TGuid read FID write FID;
  ...
  private
    ...
    [ManyValuedAssociation([TAssociationProp.Lazy], [TCascadeType.SaveUpdate, TCascadeType.Merge], 'FDepartmentID')]
    FCallList: Proxy<TList<TCall>>;
    function GetCallList: TList<TCall>;
  public
    constructor Create;
