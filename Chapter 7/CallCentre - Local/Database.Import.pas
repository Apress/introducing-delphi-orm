...
procedure createViews(const aDatabaseSession: IDatabaseSession);
var
  statement: IDBStatement;
  sqlScript: string;
begin
  Assert(aDatabaseSession <> nil);
  sqlScript:=
  ...
  statement:=aDatabaseSession.objectManager.Connection.CreateStatement;
